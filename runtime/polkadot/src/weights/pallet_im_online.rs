...
// --output=./runtime/axia/src/weights/pallet_im_online.rs
...
impl<T: frame_system::Config> pallet_im_online::WeightInfo for WeightInfo<T> {
	...
	fn validate_unsigned_and_then_heartbeat(k: u32, e: u32, ) -> Weight {
		(86_657_000 as Weight)
			// Standard Error: 0
			.saturating_add((191_000 as Weight).saturating_mul(k as Weight))
			// Standard Error: 4_000
			.saturating_add((663_000 as Weight).saturating_mul(e as Weight))
