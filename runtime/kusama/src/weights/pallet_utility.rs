...
// --output=./runtime/axctest/src/weights/pallet_utility.rs
...
impl<T: frame_system::Config> pallet_utility::WeightInfo for WeightInfo<T> {
	fn batch(c: u32, ) -> Weight {
		(21_815_000 as Weight)
			// Standard Error: 5_000
			.saturating_add((8_473_000 as Weight).saturating_mul(c as Weight))
	}
	...
	fn batch_all(c: u32, ) -> Weight {
		(19_318_000 as Weight)
			...
			.saturating_add((9_324_000 as Weight).saturating_mul(c as Weight))
	}
}
