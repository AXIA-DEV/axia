...
// --output=./runtime/axctest/src/weights/pallet_gilt.rs
...
impl<T: frame_system::Config> pallet_gilt::WeightInfo for WeightInfo<T> {
	...
	fn pursue_target_per_item(b: u32, ) -> Weight {
		(47_707_000 as Weight)
			// Standard Error: 2_000
			.saturating_add((8_484_000 as Weight).saturating_mul(b as Weight))
	...
	fn pursue_target_per_queue(q: u32, ) -> Weight {
		(17_627_000 as Weight)
			// Standard Error: 7_000
			.saturating_add((14_122_000 as Weight).saturating_mul(q as Weight))
			.saturating_add(T::DbWeight::get().reads(2 as Weight))
