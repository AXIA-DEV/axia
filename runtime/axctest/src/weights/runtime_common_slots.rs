...
// --output=./runtime/axctest/src/weights/runtime_common_slots.rs
...
impl<T: frame_system::Config> runtime_common::slots::WeightInfo for WeightInfo<T> {
	...
	fn manage_lease_period_start(c: u32, t: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add((13_128_000 as Weight).saturating_mul(c as Weight))
			// Standard Error: 21_000
			.saturating_add((29_661_000 as Weight).saturating_mul(t as Weight))
