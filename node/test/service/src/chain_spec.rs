...
use axia_test_runtime::{constants::currency::DOTS, BABE_GENESIS_EPOCH_CONFIG};
...
pub fn axia_local_testnet_genesis() -> axia_test_runtime::GenesisConfig {
...
) -> axia_test_runtime::GenesisConfig {
	use axia_test_runtime as runtime;
