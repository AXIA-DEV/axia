...
`Axlib` projects is a **OPENISH Open Source Project**
...
- A pull request that does not alter any logic (e.g. comments, dependencies, docs) may be tagged [`insubstantial`](https://github.com/paritytech/axlib/pulls?utf8=%E2%9C%93&q=is%3Apr+is%3Aopen+label%3AA2-insubstantial) and merged by its author.
...
- All other PRs should sit for 48 hours with the [`pleasereview`](https://github.com/paritytech/axlib/pulls?q=is%3Apr+is%3Aopen+label%3AA0-pleasereview) tag in order to garner feedback.
